import { loadHighScores, saveHighScore } from './saveHighScoreClrs.js';
...
export function renderHighScores(currentScore) {
  ...
  const hsContainer = document.getElementById('highScoresContainer'); // si usas este contenedor

  if (!list || !message) return;

  const localKey = 'offlineScores_Colores';
  let topPosition = -1;
