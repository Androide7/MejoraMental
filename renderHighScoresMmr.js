import { loadHighScores, saveHighScore } from './saveHighScoreMmr.js';
...
export function renderHighScores(currentScore) {
  ...
  const hsContainer = document.getElementById('highScoresContainer'); // si lo usas

  if (!list || !message) return;

  const localKey = 'offlineScores_memoria';
  let topPosition = -1;
